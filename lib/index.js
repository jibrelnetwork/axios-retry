...
function axiosRetry(axios, defaultOptions) {
  ...
  axios.interceptors.response.use(
    function(response) {
      ...
      var shouldRetry = retryCondition(response) && currentState.retryCount < retries;

      if (shouldRetry) {
        currentState.retryCount += 1;
        var delay = retryDelay(currentState.retryCount, response);
      ...
      if (config.timeout === 1) {
        var timeoutError = new Error(config.timeoutErrorMessage);
    ...
    function(error) {
      ...
      var _getRequestOptions2 = getRequestOptions(config, defaultOptions),
        ...
        retryCondition =
          _getRequestOptions2$r2 === undefined
            ? isNetworkOrIdempotentRequestError
            : _getRequestOptions2$r2,
        ...
        _getRequestOptions2$s = _getRequestOptions2.shouldResetTimeout,
        shouldResetTimeout = _getRequestOptions2$s === undefined ? false : _getRequestOptions2$s;
